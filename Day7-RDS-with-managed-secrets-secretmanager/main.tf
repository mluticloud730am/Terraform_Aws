resource "aws_db_instance" "default" {
  ...
  password             = "Cloud123"
  db_subnet_group_name = aws_db_subnet_group.sub-grp1.id
  ...
  depends_on          = [aws_db_subnet_group.sub-grp1] # Ensure subnet group is created before the DB instance
...
resource "aws_db_instance" "read_replica" {
  ...
  # Storage, engine, etc., are inherited from source_db
  skip_final_snapshot = true
}